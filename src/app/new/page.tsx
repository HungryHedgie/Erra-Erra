...
// OUTDATED: this didnt work but i spent time on it so i dont want to delete it
...
//     const inputDataButton = document.getElementById("inputDataButton") as HTMLButtonElement
